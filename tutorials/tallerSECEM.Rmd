...
```
 ...
 Materiales para el taller **Introducción a la modelización jerárquica: detectabilidad imperfecta en modelos de ocupación y N-mixture** impartido en el XVI Congreso de la SECEM (6-9 de diciembre de 2023 en Granollers).
...
* **Proceso observacional**: Mecanismo mediante el cual, a partir de una distribución o abundancia dada, emergen nuestros datos recogidos en el campo: fotos de una cámara de fototrampeo, conteos directos, registros de bioacústica, registro de indicios, muestreos de ADN ambiental, registros de ciencia ciudadana, etc.
...
Entre los sesgos más comunes en los procesos observacionales a la hora de estudiar la distribución y la abundancia de las especies es la detectabilidad imperfecta, esto es, la probabilidad de que una especie o un individuo no sea registrado estando presente en un lugar dado. Este fenómeno es muy habitual, ya que hay muchos factores que pueden afectar a la detectabilidad: el caracter elusivo de las especies, su fenología, los medios de los que disponemos para detectarlas, las condiciones metereológicas en el momento del muestreo, la experiencia del entrenador, el propio hábitat donde se encuentra la especie, etc. La detectabilidad imperfecta es especialmente importante cuando varía a través de nuestros sitios de muestreo, ya que no solo no alcanzaremos unas estimas adecuadas, sino que podríamos confundir el efecto de las covariables que afectan a la ecología de nuestra especie. 
