...
Los modelos de ocupación nos permiten estimar la **probabilidad de presencia de una especie** (a menudo denominada simplemente distribución, _variable de estado_) en nuestro área de estudio teniendo en cuenta la detectabilidad imperfecta a partir de muestreos repetidos registrando **detecciones/no detecciones** (_observaciones_). 
...
\begin{equation}
\tag{Eq 2}\label{eq2}
h_{ij}|z_{i} \sim Bernoulli(z_{i}p_{i})
\end{equation}
