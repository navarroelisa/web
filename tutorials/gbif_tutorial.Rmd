...
selFields <- c("scientificName", "decimalLatitude","decimalLongitude",
...
We will use just those fields for the rest of this tutorial
<br/><br/>

# Advanced queries and filtering

We can add different filter to our searches to refine our searches. For a complete list of available filters you can use `help(occ_search)`. Now we'll apply some of them that can be very usefull to reduce the number of registers
