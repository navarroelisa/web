...
Vemos ahora que hemos solventado el problema de la infraestima. Este modelo tan sencillo sirve para explicar de forma clara el funcionamiento del modelo N-mixture binomial. Sin embargo, la abundancia normalmente suele venir determinada por alguna covariable predictora que afecta a la distribución de las especies, como disponibilidad de recursos, refucio, etc. Por eso, a continuación simularemos otro set de datos y ajustatemos un modelo algo más complejo.


# Modelo N-mixture con covariables en _unmarked_
